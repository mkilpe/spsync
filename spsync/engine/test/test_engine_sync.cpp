...
// - (7) two clients both try to commit follow up for record -> one fails (conflict)
// - (8) multi client set-up where all commits (other modes than allow all)
// - (9) two clients, one is off-line and does changes and goes then on-line
